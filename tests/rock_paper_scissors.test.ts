...
import RockPaperScissorsFactory from "../typedContracts/rock_paper_scissors/constructors/rock_paper_scissors";
import RockPaperScissors from "../typedContracts/rock_paper_scissors/contracts/rock_paper_scissors";
import { ApiPromise, WsProvider, Keyring } from "@polkadot/api";
import { KeyringPair } from "@polkadot/keyring/types";
import { GameConfigs } from '../typedContracts/rock_paper_scissors/types-arguments/rock_paper_scissors';
...
describe("RockPaperScissors E2E Tests", () => {
  const DEFAULT_MAX_PLAYERS = 2;
  const DEFAULT_MIN_PLAYERS = 2;
  const ACTORS = ['//Bob', '//Alice', '//Charlie'];

  let factory: RockPaperScissorsFactory;
  let api: ApiPromise;
  ...
  beforeEach(async function setup(): Promise<void> {
    ...
    factory = new RockPaperScissorsFactory(api, deployer);
    ...
    contract = new RockPaperScissors(
